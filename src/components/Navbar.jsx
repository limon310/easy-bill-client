...
const Navbar = () => {
    ...
    const links = <>
        ...
        <li><NavLink to='/bills'>All Bills</NavLink></li>
        {
            user && <>
                {/* <li><NavLink to='/myPayBills'>My Bills</NavLink></li> */}
        ...
        <div className='w-full bg-base-100 shadow-sm'>
            <div className="max-w-7xl mx-auto navbar  flex justify-center items-center">
                <div className="navbar-start">
                    ...
                    <Link to="/" className="btn btn-ghost text-xl">Easy<span className='text-primary'>Bill</span></Link>
                ...
                <div className="navbar-end">
                    ...
                    {user ? (
                        ...
                        <Link
                            to={"/login"}
                            className="btn rounded-lg py-3 px-5 btn-primary"
                        >
                            {" "}
                            Login
                        </Link>
